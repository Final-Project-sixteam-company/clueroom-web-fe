...
| 운영 smoke | library/detail/mobile CTA/case tabs/interrogation/final validation core flow PASS |
| 릴리스 게이트 | 공개 `/`에서 QA/dev login 미노출, bookmark/review persistence, refresh-cookie retry를 배포 후 재확인 |
